...
import com.eeerrorcode.pilllaw.dto.member.VerifyTokenDto;
...
public class SignupController {
  ...
  public ResponseEntity<?> verifyEmail(@RequestBody VerifyTokenDto dto) {
    boolean isVerified = mailService.verifyEmail(dto.getToken());
    if (isVerified) {
